...
public class Solution extends AppCompatActivity implements AdapterView.OnItemSelectedListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    String[] problems = {"Solution Type", "Solid Waste", "Sewage", "Encroachments", "Tree Cutting", "Other"};
    String[] areas = {"Solution Area", "Saddar", "Korangi", "Shah Faisal", "Jamshed", "Gulshan", "North Nazimabad", "New Karachi", "Malir", "Keamari", "Landhi", "Lyari", "Gadap", "Bin Qasim", "SITE", "Baldia", "Gulberg", "Orangi", "Liaquatabad"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loader = new ProgressDialog(Solution.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.statistics) {
            ...
            Intent in = new Intent(Solution.this, Statistics.class);
            startActivity(in);
            this.finish();
        } else if (item.getItemId() == R.id.my_solutions) {
            Log.d("Status", "Solutions");
            Intent in = new Intent(Solution.this, Home.class);
            startActivity(in);
            this.finish();
            ...
            Log.d("Status", "Logout");
            AlertDialog.Builder builder = new AlertDialog.Builder(Solution.this);
            ...
            builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    new LocalDatabase().clear(Solution.this);
                    Intent i = new Intent(Solution.this, Login.class);
                    startActivity(i);
                    finishAffinity();
                }
            });
            ...
            Intent in = new Intent(Solution.this, Map.class);
            startActivity(in);
            this.finish();
        }
    ...
    private void uploadImage(byte[] data) {
        ...
        String refString = new Date().toString() + "-" + issueTypeSelected + "-" + issueAreaSelected + "-" + firebaseAuth.getCurrentUser().getUid() + "solution.jpg";
        StorageReference picImagesRef = storageRef.child("solutions/" + refString);
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                loader.dismiss();
                Toast.makeText(Solution.this, "There was an error. Try again.", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                loader.setMessage("Submitting solution...");
                databaseReference.child("solutions").push().setValue(new IssueObj(detail.getText().toString(), issueTypeSelected, issueAreaSelected, lat, lng, firebaseAuth.getCurrentUser().getUid(), String.valueOf(downloadUrl))).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        loader.dismiss();
                        Toast.makeText(Solution.this, "Solution submitted", Toast.LENGTH_SHORT).show();
                        Intent in = new Intent(Solution.this, Home.class);
                        startActivity(in);
                        finish();
                    }
        ...
        switch (view.getId()) {
            case R.id.submit:
                if (typePos == 0 || areaPos == 0 || detail.getText().toString().trim().length() == 0) {
                    Toast.makeText(this, "Please enter details to submit a solution.", Toast.LENGTH_SHORT).show();
                } else if (byteArray == null) {
                    Toast.makeText(this, "Please upload a picture to submit a solution.", Toast.LENGTH_SHORT).show();
                } else {
                    loader.show();
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            if (checkSelfPermission(Manifest.permission.CAMERA)
                                ...
                                ActivityCompat.requestPermissions(Solution.this, new String[]{Manifest.permission.CAMERA},
                                        PERMISSION_REQUEST);
                            } else {
